...
public class BDG_GetAllUsersItem implements Serializable {
    ...
    private int typeRefresh; // This is the parameter passed to the constructor

    // Constructor with TYPE_REFRESH
    public BDG_GetAllUsersItem(int TYPE_REFRESH) {
        this.typeRefresh = TYPE_REFRESH;
    }
